...
Sprint: Sprint 4 gate; originated in Sprint 3
...
| Tester handoff | Conditional pass | Draft-lane tester handoff is owner-reviewed; tester invite remains gated by isolated clean-Windows smoke. |
...
| Clean-Windows installation guide | Pass for preparation | Windows draft-lane setup guide exists; Windows Sandbox surrogate trial is pending. |
| Release smoke | Partial pass | Current workspace smoke passed with Python override; isolated clean-Windows smoke record is still required. |
...
- isolated Windows installation record from `docs/setup/windows-draft-lane-beta-install.md`
...
- isolated clean-Windows smoke record or owner-assigned blocker before any tester invite
